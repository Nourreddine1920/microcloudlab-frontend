  ...
  return (
    <div className="bg-gradient-to-br from-primary/5 to-accent/5 rounded-xl p-6 border border-primary/10">
      <div className="text-center mb-8">
        <h2 className="text-2xl font-headline text-text-primary mb-3">
      ...
      <div className="bg-background rounded-lg p-6 shadow-brand">
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div>
            <div className="flex items-center space-x-3 mb-4">
              ...
              <div>
                <h3 className="text-xl font-semibold text-text-primary">{currentFeature.title}</h3>
                <p className="text-text-secondary text-sm">Revolutionary capability</p>
              </div>
            </div>
            ...
            <div className="space-y-3">
              <h4 className="font-medium text-text-primary">Key Benefits:</h4>
          ...
          {/* Comparison */}
          <div>
            <h4 className="font-medium text-text-primary mb-4">Traditional vs MicroCloudLab</h4>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-error/5 border border-error/20 rounded-lg p-4">
                <div className="flex items-center space-x-2 mb-2">
                  ...
                  <span className="font-medium text-error text-sm">Traditional Approach</span>
                </div>
              ...
              <div className="bg-success/5 border border-success/20 rounded-lg p-4">
                <div className="flex items-center space-x-2 mb-2">
                  ...
                  <span className="font-medium text-success text-sm">MicroCloudLab Way</span>
                </div>
            ...
            <div className="mt-6 p-4 bg-gradient-to-r from-accent/10 to-primary/10 rounded-lg border border-accent/20">
              <div className="text-center">
                <p className="text-text-primary font-medium mb-3">Ready to experience the difference?</p>
                <Button
                  variant="primary"
                  iconName="Rocket"
                  iconPosition="left"
        ...
        {features.map((_, index) => (
          <button
            ...
            className={`w-2 h-2 rounded-full transition-all duration-200 ${
              activeFeature === index ? 'bg-primary w-8' : 'bg-border hover:bg-primary/50'
            }`}
          />
        ))}
      </div>
