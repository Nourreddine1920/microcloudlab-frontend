 ...
 * @param {Function} props.onExport - Callback function to handle the export action. Receives the selected configuration.
 * @param {Function} props.onEdit - Callback function to handle the edit action. Receives the selected configuration.
 * @param {Function} props.onCompare - Callback function to handle adding a configuration to the comparison. Receives the selected configuration.
